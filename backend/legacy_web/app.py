...
from legacy_web.auth import router as auth_router
from legacy_web.csrf import CSRFMiddleware
from legacy_web.deps import (
    AuthMiddleware,
    DBConnectionMiddleware,
    MFAEnforcementMiddleware,
    RequestServicesMiddleware,
)
from legacy_web.guards import install_guard_handlers
from legacy_web.middleware.logging import RequestContextMiddleware
from legacy_web.routes.bill import router as bill_router
from legacy_web.routes.billing import router as billing_router
from legacy_web.routes.communication import router as communication_router
from legacy_web.routes.expense import router as expense_router
from legacy_web.routes.google_auth import router as google_auth_router
from legacy_web.routes.health import router as health_router
from legacy_web.routes.invite import router as invite_router
from legacy_web.routes.organization import router as organization_router
from legacy_web.routes.password_reset import router as password_reset_router
from legacy_web.routes.security import router as security_router
from legacy_web.routes.seo import router as seo_router
from legacy_web.routes.theme import router as theme_router
...
async def http_exception_handler(request: Request, exc: StarletteHTTPException):
    if exc.status_code == 404:
        from legacy_web.analytics import attach_to_context
        from legacy_web.csrf import get_csrf_token
        from legacy_web.flash import get_flashed_messages
