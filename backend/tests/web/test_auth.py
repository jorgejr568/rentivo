class TestUnknownRoutes:
    ...
    def test_path_matches_route_without_app_in_scope(self):
        ...
        from legacy_web.deps import _path_matches_route
...
class TestRateLimiting:
    def test_rate_limited_after_too_many_attempts(self, client, test_engine):
        ...
        import legacy_web.auth as auth_module
...
class TestMFAEnforcementMiddlewareDirect:
    ...
    def test_no_user_id_passes_through(self):
        ...
        from legacy_web.deps import MFAEnforcementMiddleware
...
class TestRateLimiterClass:
    ...
    def _limiter(self, max_attempts=3, window_seconds=60):
        from legacy_web.auth import RateLimiter
